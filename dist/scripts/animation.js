...
document.addEventListener("DOMContentLoaded", () => {
    ...
    ["hero-left-gradient", "hero-right-gradient"].forEach((className) => {
        ...
        gsap.fromTo(".about__experience__year", { y: -50, opacity: 0 }, {
            duration: 1,
            y: 0,
            opacity: 1,
            ease: "power1.out",
        ...
        gsap.fromTo(".about__experience__content", { y: -50, opacity: 0 }, {
            duration: 1,
            y: 0,
            opacity: 1,
            delay: 0.2,
        ...
        gsap.fromTo(".about__coding", { y: -50, opacity: 0 }, {
            duration: 1,
            y: 0,
            opacity: 1,
            delay: 0.4,
        ...
        gsap.fromTo(".about__testing", { y: -150, opacity: 0 }, {
            duration: 1,
            y: 0,
            opacity: 1,
            delay: 0.6,
    ...
    gsap.fromTo(".chat__wrap", { y: 50, opacity: 0 }, {
        duration: 1.1,
        y: 0,
        opacity: 1,
        ease: "power1.out",
    ...
    gsap.fromTo(".contact__wrap", { y: 50, opacity: 0 }, {
        duration: 1.1,
        y: 0,
        opacity: 1,
        ease: "power1.out",
    ...
    gsap.fromTo(".contact-form__wrap", { y: 50, opacity: 0 }, {
        duration: 1.1,
        y: 0,
        opacity: 1,
        ease: "power1.out",
